...
**Get in touch:**
- Registry: wardscribe.io
- AGNTCY: agntcy.org
- CLI source: Apache 2.0

WardScribe is an AGNTCY Adopter, a member of the Linux Foundation project for agent interoperability.
